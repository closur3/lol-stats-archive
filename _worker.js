...
const PYTHON_STYLE = `
    ...
    .modal-content { background-color: #f8fafc; margin: 10% auto; padding: 16px 12px; border: 1px solid #cbd5e1; width: 280px; border-radius: 16px; box-shadow: 0 20px 25px -5px rgba(0,0,0,0.1), 0 8px 10px -6px rgba(0,0,0,0.1); animation: fadeIn 0.2s; }
    ...
    /* 移除 FULL 冗余列，强化中轴对齐 */
    .match-item.history-layout { grid-template-columns: max-content 22px 1fr 42px 1fr; }
    .match-item.dist-layout { grid-template-columns: max-content 1fr 42px 1fr; }
    ...
    .score-text { font-weight: 800; font-size: 13px; color: #334155; font-variant-numeric: tabular-nums; letter-spacing: 0.5px; }
