...
function renderBuildFooter(time, sha) {
    ...
    return `<div class="build-footer"><code>deployed: ${time || "N/A"}</code> <a href="https://github.com/closur3/lol-stats-archive/commit/${sha}" target="_blank"><code>@${shortSha}</code></a></div>`;
}
