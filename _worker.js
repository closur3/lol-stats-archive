...
const PYTHON_STYLE = `
    ...
    #modalTitle { margin: 0 0 12px 0; font-size: 18px; font-weight: 800; color: #1e293b; white-space: nowrap; text-align: left; }
    ...
    .match-item.dist-layout { grid-template-columns: 50px 45px 50px 45px; justify-content: center; gap: 16px; }
    ...
    .col-res { font-weight: 900; font-size: 15px; text-align: center; line-height: 1; white-space: nowrap; }
