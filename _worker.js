...
const PYTHON_STYLE = `
    ...
    #modalTitle { text-align: left; margin: 0 0 12px 3px; padding-bottom: 12px; border-bottom: 1px solid #cbd5e1; font-size: 18px; font-weight: 800; color: #1e293b; white-space: nowrap; }
