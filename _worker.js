...
const PYTHON_STYLE = `
    ...
    .sch-time { width: 55px; color: #94a3b8; font-size: 13px; display:flex; align-items:center; justify-content:center; } 
    .sch-tag-col { width: 55px; display: flex; align-items:center; justify-content: center; }
