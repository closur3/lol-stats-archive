...
const PYTHON_STYLE = `
    ...
    #modalTitle { text-align: left; margin: 0 -20px 12px -20px; padding: 0 20px 12px 22px; border-bottom: 1px solid #e2e8f0; font-size: 18px; font-weight: 800; color: #1e293b; white-space: nowrap; }
