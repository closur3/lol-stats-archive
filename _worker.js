...
const PYTHON_STYLE = `
    ...
    .sch-time { width: 50px; color: #94a3b8; font-size: 13px; display:flex; align-items:center; justify-content:center; } 
    .sch-tag-col { width: 50px; display: flex; align-items:center; justify-content: center; }
