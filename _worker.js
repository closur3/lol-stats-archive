...
const PYTHON_STYLE = `
    ...
    /* 核心改造：卡片化排列 */
    .match-item { display: grid; align-items: center; background: #fff; border: 1px solid #e2e8f0; border-radius: 10px; margin-bottom: 8px; padding: 8px 16px; gap: 5px; box-shadow: 0 1px 2px rgba(0,0,0,0.02); transition: all 0.2s; min-height: 38px; }
    ...
    .score-box { position: relative; display: flex; align-items: center; justify-content: center; background: #f1f5f9; border: 1px solid #e2e8f0; border-radius: 6px; height: 18px; padding: 0; transition: 0.2s; }
    ...
    .score-text { font-weight: 800; font-size: 13px; color: #334155; font-variant-numeric: tabular-nums; letter-spacing: 1px; line-height: 1; }
