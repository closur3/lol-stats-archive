...
const PYTHON_STYLE = `
    ...
    .sch-row .spine-l { padding: 4px 5px; margin-left: 12px; }
    .sch-row .spine-r { padding: 4px 5px; margin-right: 12px; }
    ...
    .sch-time { width: 60px; color: #94a3b8; font-size: 13px; display: flex; align-items: center; justify-content: center; padding: 0; }
    .sch-tag-col { width: 60px; display: flex; align-items: center; justify-content: center; padding: 0; }
