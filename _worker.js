// ====================================================
// 🥇 Worker V36.2.60: 统计表同款样式 & 自然高度版
// 基于: V36.2.59
// 变更: 
// 1. 恢复自然高度 (align-items: start)，消除卡片底部空白
// 2. 赛程列表的队名样式调整为与上方统计表(Table)完全一致 (去除了胶囊感，统一交互色)
// ====================================================

const UI_VERSION = "2026-02-04-V36.2.60-NaturalHeight-TableStyle";
...
const PYTHON_STYLE = `
    ...
    /* 核心变更: 统一样式，team-text 现在和 table 中的 team-col 表现一致 */
    .team-text { font-weight: 800; color: #334155; padding: 2px 4px; border-radius: 4px; transition: all 0.2s; display: inline-block; }
    .team-clickable { cursor: pointer; } 
    /* 核心变更: Hover颜色与Table完全一致 */
