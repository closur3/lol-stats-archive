                ...
                try {
                    ...
                    container.innerHTML = tournaments.map(t => {
                        ...
                        return '<div class="qr-item">' +
                            '<label class="qr-label">' +
                            '<input type="checkbox" class="form-checkbox qr-chk-active" value="' + slug + '">' +
                            ...
                            '<button class="fill-btn" onclick="fillArchive(&apos;' + slug + '&apos;)" title="Fill">📋</button>' +
                            '<button class="delete-btn" onclick="deleteArchive(&apos;' + slug + '&apos;, &apos;' + name + '&apos;)" title="Delete">🗑️</button>' +
                            '</div>' +
                            '</div>';
                    }).join('');
