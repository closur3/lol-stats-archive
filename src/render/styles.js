...
export const TOOLS_PAGE_STYLE = `
    ...
    .qr-league { font-size: 12px; font-weight: 700; color: #fff; background: #94a3b8; padding: 2px 6px; border-radius: 4px; flex-shrink: 0; width: 36px; display: flex; justify-content: center; align-items: center; white-space: nowrap; }
